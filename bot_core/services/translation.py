...
from bot_core.telemetry import atimed, log_timing
...
async def translate_html(html_str: str, target: str = "ar") -> str:
    ...
    async with atimed("translate.html", target=target_lang, html_len=len(html_input) if html_input else 0):
        try:
